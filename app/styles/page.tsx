...
export const metadata: Metadata = {
  title: 'Styles — ChatGPT, Claude, Claude Code, Codex, Gemini, Perplexity & Juma Agent Inputs',
  description:
    'Ready-made agent-input styles built with Prompt Area: a ChatGPT-style composer, a Claude-style composer, a Claude Code–style composer, an OpenAI Codex–style composer, a Google Gemini–style composer, a Perplexity-style composer, and a Juma-style composer, assembled from Prompt Area, Action Bar, and Status Bar.',
  ...
  openGraph: {
    ...
    title: 'Styles — ChatGPT, Claude, Claude Code, Codex, Gemini, Perplexity & Juma Agent Inputs',
    description:
      'Ready-made agent-input styles built with Prompt Area — ChatGPT, Claude, Claude Code, OpenAI Codex, Google Gemini, Perplexity, and Juma composers you can drop into your app.',
  },
}
